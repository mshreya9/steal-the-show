  ...
  return (
    <div className="container-shell py-8">
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
        {/* Gallery */}
        <div>
          <div className="aspect-[4/5] overflow-hidden rounded-2xl bg-plum-50">
            <img src={product.image} alt={product.name} className="h-full w-full object-cover" />
          </div>
          <div className="mt-3 grid grid-cols-4 gap-3">
            {[0, 1, 2, 3].map((i) => (
              <div key={i} className="aspect-square overflow-hidden rounded-xl bg-plum-50 opacity-70">
            ...
            <div className="mt-8 rounded-2xl border border-grey-200 bg-white p-5">
              ...
              <div className="mt-1.5 flex gap-2">
                <input
                  ...
                  placeholder="e.g. 30"
                  className="w-32 rounded-xl border border-grey-300 px-3 py-2 text-sm focus:border-plum focus:outline-none"
                />
              </div>
